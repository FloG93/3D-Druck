...
<div class="dialog-inner">
  ...
  <div class="dialog-body">
    <h3>So geht's</h3>
    <ol>
      <li><b>Vorlage</b> wählen oder direkt den <b>Text</b> eintippen. Mehrere Zeilen mit Enter.</li>
      <li><b>Schrift</b>: sechs Schriften sind eingebaut, unter <i>Mehr …</i> gibt es alle Google Fonts mit Vorschau.</li>
      <li><b>Grundform</b> (Kontur, Rechteck, Kapsel, Oval, Kreis oder ohne Platte) und <b>Befestigung</b> (Öse, Loch) einstellen.</li>
      <li><b>Körper (3D)</b>: Schrift erhaben, vertieft oder <b>bündig</b> (zweifarbig mit glatter Oberfläche), Dicken, erhabener Rand.</li>
      <li><b>Exportieren</b> als 3MF: Platte, Schrift und Rand sind eigene Teile mit fester Filament-Nummer – in Bambu Studio nur noch die AMS-Farben wählen.</li>
    </ol>
    ...
    <ul>
      ...
      <li>Mit <b>+</b> bei „Text“ kommen weitere Texte dazu (z. B. Name groß, Untertitel klein). Jeder Text lässt sich in der Vorschau mit der Maus verschieben (Shift: ohne Raster).</li>
