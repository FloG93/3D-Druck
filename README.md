...
| **Text-Generator** | Schlüsselanhänger, Namens-, Tür-, WLAN- und Kofferschilder und Schablonen: jede Google-Schrift, Symbole, QR-Codes, eigene Grafiken, Rückseite, Öse, Schrauben oder Magnete, Schrift erhaben, vertieft, bündig oder als Schablone mit Stegen (große in Puzzle-Teilen). 3MF für Bambu Studio mit AMS-Zuordnung, STL, SVG, DXF. | [Öffnen](https://flog93.github.io/3D-Druck/Text-Generator/) | [Text-Generator](Text-Generator/README.md) |
