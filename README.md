...
- **29 Vorlagen** – Lochmuster: Wirbel, Wabe, Fischgrät, Sonnenblume, Verlauf, Strömung, Lautsprecher, Ringe, Rauten, Organisch, Zahnrad, Fokus, Lamellen, Kristall, Kiesel, Regen, Namensschild; Relief: Griffrillen, Kühlrippen, Kühlstifte, Noppen, Wabenprägung; Zylinder: Stifthalter, Griffhülse, Lampenschirm, Wirbelvase; Rändelung: Rändelknopf, Rändel gerade, Rändelplatte. Dazu eigene Vorlagen, Projektdateien (JSON), **Teilen-Link**, Rückgängig/Wiederholen, automatisches Speichern im Browser, helles und dunkles Design.
